...
import {getProperties,getPropertyByAddress,addNewProperty,editProperty,useAddressToFindPosition, updatePropertyPrice} from '../controllers/propertyControllers.js'
...
router.route('/:address').get(getPropertyByAddress).post(updatePropertyPrice)
