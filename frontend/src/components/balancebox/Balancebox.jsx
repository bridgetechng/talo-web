    ...
    return(
         <>
          ...
          <h4 className="messageTitle"> Wallet</h4>
              ...
              <Balanceitem name={"INVESTMENT"} symbol={"loans"} value={0} /> {/* this 0 is supposed to be from userInfo.userInfo.loans , but i dont know whether loans will be a single value or an array in the database */}
